...
public final class Guest extends com.google.api.client.json.GenericJson {
   ...
   */
  public Guest setAccessRights(java.lang.String accessRights) {
   ...
   */
  public Guest setDirty(java.lang.Boolean dirty) {
    this.dirty = dirty;
    return this;
  }
   ...
   */
  public Guest setEmailAddress(EmailAddress emailAddress) {
   ...
   */
  public Guest setHttpSessionId(java.lang.String httpSessionId) {
   ...
   */
  public Guest setLanguage(java.lang.String language) {
   ...
   */
  public Guest setLanguageConfiguration(ModelConfig languageConfiguration) {
   ...
   */
  public Guest setLastPraisedPhoto(Photo lastPraisedPhoto) {
   ...
   */
  public Guest setNickName(java.lang.String nickName) {
   ...
   */
  public Guest setPhotoSize(java.lang.String photoSize) {
   ...
   */
  public Guest setPraisedPhotoIds(java.util.List<PhotoId> praisedPhotoIds) {
   ...
   */
  public Guest setSkippedPhotoIds(java.util.List<PhotoId> skippedPhotoIds) {
    this.skippedPhotoIds = skippedPhotoIds;
    return this;
  }

  @Override
  public Guest set(String fieldName, Object value) {
    return (Guest) super.set(fieldName, value);
  }
